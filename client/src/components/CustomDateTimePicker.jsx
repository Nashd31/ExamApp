...
const CustomDateTimePicker = ({ value, onChange, label, alignRight = false }) => {
  ...
  // Keep track of last value prop processed to adjust state when prop changes
  ...
  return (
    <div className="custom-dt-container" ref={containerRef}>
      ...
      >
        ...
        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" style={{ color: 'var(--theme-color)' }}>
